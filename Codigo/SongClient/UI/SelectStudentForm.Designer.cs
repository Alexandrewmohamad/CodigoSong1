namespace PnT.SongClient.UI
{
    partial class SelectStudentForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.mcbStudent = new MetroFramework.Controls.MetroComboBox();
            this.mlblStudent = new MetroFramework.Controls.MetroLabel();
            ...
            this.pnStudent.Controls.Add(this.mcbStudent);
            this.pnStudent.Controls.Add(this.mlblStudent);
            resources.ApplyResources(this.pnStudent, "pnStudent");
            this.pnStudent.Name = "pnStudent";
            // 
            // mcbStudent
            // 
            this.mcbStudent.DisplayMember = "Description";
            this.mcbStudent.DropDownWidth = 150;
            this.mcbStudent.FontSize = MetroFramework.MetroComboBoxSize.Small;
            this.mcbStudent.FontWeight = MetroFramework.MetroComboBoxWeight.Light;
            this.mcbStudent.FormattingEnabled = true;
            resources.ApplyResources(this.mcbStudent, "mcbStudent");
            this.mcbStudent.Name = "mcbStudent";
            this.mcbStudent.UseSelectable = true;
            this.mcbStudent.ValueMember = "Id";
            this.mcbStudent.SelectedIndexChanged += new System.EventHandler(this.mcbStudent_SelectedIndexChanged);
            // 
            // mlblStudent
            // 
            this.mlblStudent.FontSize = MetroFramework.MetroLabelSize.Small;
            resources.ApplyResources(this.mlblStudent, "mlblStudent");
            this.mlblStudent.Name = "mlblStudent";
            // 
            // mbtnCancel
            // 
        ...
        private MetroFramework.Controls.MetroComboBox mcbStudent;
        private MetroFramework.Controls.MetroLabel mlblStudent;
    }
}