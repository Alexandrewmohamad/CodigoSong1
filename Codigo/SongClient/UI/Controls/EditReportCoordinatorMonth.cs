...
namespace PnT.SongClient.UI.Controls
{
    ...
    /// </summary>
    public partial class EditReportCoordinatorMonth : UserControl, ISongControl
    {
        ...
        /// </param>
        public EditReportCoordinatorMonth(Report report)
        {
            //set report
            this.report = report;
            ...
            //set grade headers
            mlblGrade0.Text = Properties.Resources.GradeSubject_Punctuality;
            mlblGrade1.Text = Properties.Resources.GradeSubject_Charisma;
            mlblGrade2.Text = Properties.Resources.GradeSubject_Proactivity;
            mlblGrade3.Text = Properties.Resources.GradeSubject_Creativity;
            mlblGrade4.Text = Properties.Resources.GradeSubject_Organization;
            mlblGrade5.Text = Properties.Resources.GradeSubject_Didactic;
        ...
        private bool LoadItemData()
        {
            ...
            try
            {
                ...
                //display report data
                mlblReportData.Text = report.SemesterDescription + "." + 
                    report.ReferenceDate.Month + " " + monthName + " | " + report.InstitutionName;
                ...
                answers = songChannel.FindAnswersByFilter(
                    (int)QuestionRapporteur.Coordinator, -1, (int)QuestionPeriodicity.Month, -1,
                ...
                //calculate complete percentage
                percentage = ((double)reportAnswers.Count) / 6.0 * 100.0;
        ...
        private void DisplayGrades()
        {
            ...
            foreach (IdDescriptionStatus teacher in classTeachers)
            {
                ...
                teacherGrades[0] = GetOrCreateGrade(teacher, GradeSubject.Punctuality);
                teacherGrades[1] = GetOrCreateGrade(teacher, GradeSubject.Charisma);
                teacherGrades[2] = GetOrCreateGrade(teacher, GradeSubject.Proactivity);
                teacherGrades[3] = GetOrCreateGrade(teacher, GradeSubject.Creativity);
                teacherGrades[4] = GetOrCreateGrade(teacher, GradeSubject.Organization);
                teacherGrades[5] = GetOrCreateGrade(teacher, GradeSubject.Didactic);
        ...
        {
            //display questions
            DisplayQuestion(qcQuestion1, allQuestions.Find(q => q.QuestionId == 9));
            DisplayQuestion(qcQuestion2, allQuestions.Find(q => q.QuestionId == 10));
            DisplayQuestion(qcQuestion3, allQuestions.Find(q => q.QuestionId == 11));
            DisplayQuestion(qcQuestion4, allQuestions.Find(q => q.QuestionId == 12));
            DisplayQuestion(qcQuestion5, allQuestions.Find(q => q.QuestionId == 13));
            DisplayQuestion(qcQuestion6, allQuestions.Find(q => q.QuestionId == 14));
        }
        ...
        private void EnableGradeFields()
        {
            ...
            mlblGradeScroll.Visible = classTeachers.Count > 8;
        }
        ...
        private bool ValidateData()
        {
            ...
            if (!ValidateAnswerComments(qcQuestion6, tbQuestions))
            {
                //invalid field
                return false;
            }
        ...
        /// <param name="e"></param>
        private void EditReportCoordinatorMonth_Load(object sender, EventArgs e)
        {
            //check if control is in design mode
            if (this.DesignMode)
            {
            ...
            if (!isConstructed)
            {
                ...
                throw new ApplicationException(
                    "Load event handler called before constructor is done at EditReportCoordinatorMonth.");
            }
        ...
        private void btEdit_Click(object sender, EventArgs e)
        {
            ...
            //user can edit report one week before end of month
            editionDate = report.ReferenceDate.AddMonths(1).AddDays(-7);
    ...
    } //end of class EditReportCoordinatorMonth
