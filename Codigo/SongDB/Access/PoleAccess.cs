...
namespace PnT.SongDB.Access
{
    ...
    /// <summary>
    /// Summary description for PoleAccess.
    /// </summary>
    public class PoleAccess
    {

        #region Queries ****************************************************************

        private const string FIND_POLE = @"SELECT * FROM pole {0} {1} {2}";

        private const string SAVE_POLE = @"INSERT INTO pole (institutionId, name, address, district, city, state, zipCode, phone, mobile, email, description, poleStatus, creationTime, inactivationTime, inactivationReason) 
            VALUES (@institutionId, @name, @address, @district, @city, @state, @zipCode, @phone, @mobile, @email, @description, @poleStatus, @creationTime, @inactivationTime, @inactivationReason); 
            SELECT @@IDENTITY;";

        private const string UPDATE_POLE = @"UPDATE pole 
            SET institutionId=@institutionId, name=@name, address=@address, district=@district, city=@city, state=@state, zipCode=@zipCode, phone=@phone, mobile=@mobile, email=@email, description=@description, poleStatus=@poleStatus, inactivationTime=@inactivationTime, inactivationReason=@inactivationReason
             WHERE poleId=@poleId";

        private const string DELETE_POLE = @"DELETE FROM pole WHERE poleId=@poleId";

        private const string INACTIVATE_POLE = @"UPDATE pole SET poleStatus=1, inactivationTime=@inactivationTime, inactivationReason=@inactivationReason WHERE poleId=@poleId";
        ...
        public static bool Delete(MySqlTransaction trans, int id)
        {
            ...
            try
            {
                ...
                //delete existing row
                MySqlCommand comm = new MySqlCommand();
                comm.CommandText = DELETE_POLE;
                comm.Connection = connection;
                comm.Transaction = transaction;
                comm.CommandTimeout = PnT.SongDB.ConnectionSettings.SongDBTimeout;
                comm.Parameters.AddWithValue("@poleId", id);
        ...
        public static bool Inactivate(MySqlTransaction trans, int id, string inactivationReason)
        {
            ...
            try
            {
                ...
                MySqlCommand comm = new MySqlCommand();
                comm.CommandText = INACTIVATE_POLE;
                comm.Connection = connection;
                comm.Transaction = transaction;
                comm.CommandTimeout = PnT.SongDB.ConnectionSettings.SongDBTimeout;
                comm.Parameters.AddWithValue("@poleId", id);
        ...
        public static DataRow[] Find(MySqlTransaction trans)
        {
            ...
            try
            {
                ...
                using (MySqlDataAdapter da = new MySqlDataAdapter())
                {
                    ...
                    string orderBy = " ORDER BY poleId";
                    string query = string.Format(FIND_POLE, string.Empty, orderBy, string.Empty);
        ...
        public static DataRow[] FindByTeacher(MySqlTransaction trans, int teacherId)
        {
            ...
            try
            {
                ...
                using (MySqlDataAdapter da = new MySqlDataAdapter())
                {
                    ...
                    string query = "SELECT p.* FROM pole p " +
                        "INNER JOIN teacherpole tp ON p.poleId = tp.poleId " +
                        "INNER JOIN teacher t ON tp.teacherId = t.teacherId " +
        ...
        public static DataRow Find(MySqlTransaction trans, int id)
        {
            ...
            try
            {
                ...
                using (MySqlDataAdapter da = new MySqlDataAdapter())
                {
                    ...
                    string where = " WHERE poleId = @id ";
                    string query = string.Format(FIND_POLE, where, string.Empty, string.Empty);
            ...
            MySqlTransaction trans, int filterPoleStatus, int filterInstitution)
        {
            ...
            try
            {
                ...
                using (MySqlCommand da = new MySqlCommand())
                {
                    ...
                    //check filters
                    //check status filter
                    if (filterPoleStatus > -1)
                    {
                        //add status filter and parameter
                        where += " poleStatus=@poleStatus AND";
                        da.Parameters.AddWithValue("@poleStatus", filterPoleStatus);
                    }
            ...
            try
            {
                ...
                using (MySqlDataAdapter da = new MySqlDataAdapter())
                {
                    ...
                    if (filterPoleStatus > -1)
                    {
                        //add status filter and parameter
                        where += " poleStatus=@poleStatus AND";
                        da.SelectCommand.Parameters.AddWithValue("@poleStatus", filterPoleStatus);
                    }
                    ...
                    //set query
                    string orderBy = " ORDER BY poleId";
                    string query = string.Format(FIND_POLE, where, orderBy, string.Empty);
                    da.SelectCommand.CommandText = query;
